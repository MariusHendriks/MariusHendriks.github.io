      ...
      <div class="container">
        <div class="row">
          <div class="intro-text">
            <h1><img class="tayyabslogoHeader" src="img/tayyabslogo_wite.png"></h1>
            <p class="headetext">PURVEYORS OF FINE TRADITIONAL<BR />PUNJANI CUSINE SINCE 1972</p>
			<a target="_blank" href="https://deliveroo.co.uk/menu/london/whitechapel/tayyabs?utm_source=google&utm_medium=cpc&utm_term=tayyabs&utm_campaign=**^Acquisition^Search^Restaurants^UK^London^EC^Exact^^Tayyabs^~28041~^&gclid=Cj0KEQiA9P7FBRCtoO33_LGUtPQBEiQAU_tBgDkWaBFj9FxnXFCuznHqpWFvr0rDsNXy8lu85ChfvBoaAgv18P8HAQ">
...
<!-- About Section -->
<div id="staticmenu">
	<div class="menuLogoMenu">
		<img class="tayyabslogofinal" src="img/tayyabslogo_final.png" />
	</div>
	<a target="_blank"  href="https://widget.resdiary.com/(S(ob2n2zirwu422zzlxqmdo2nq))/CheckAvailability.aspx?sourceKey=rd&id=4943">
		<div  class="bookatableMenu menuoptions">
			Book a table
		</div>
	</a>
	<div class="contactusMenu menuoptions">
		Contact us
	</div>
	<div class="tayyabsMenu menuoptions">
		Tayyabs Menu
	</div>
	<div class="aboutusMenu menuoptions">
		About us
	</div>
</div>
<div id="socialmediabar">
	<div class="jointhefamliy">
		Join the tayyabs Family!
	</div>
	<a target="_blank"  href="https://www.instagram.com/explore/tags/tayyabs/">
		<div class="instagramicon">
		</div>
	</a>
	<a target="_blank"  href="https://www.facebook.com/Tayyabs-148673418506108/?fref=ts">
		<div class="facebookicon">
		</div>
	</a>
	<a target="_blank"  href="https://twitter.com/1tayyabs">
		<div class="twittericon">
		</div>
	</a>
	<a target="_blank"  href="https://www.instagram.com/explore/tags/tayyabs/">
		<div class="socialmediaicon">
			<img id="socialinsta" class="socialmediaiconimg" src="img/instagram.png" />
		</div>
	</a>
	<a target="_blank"  href="https://www.facebook.com/Tayyabs-148673418506108/?fref=ts">
		<div class="socialmediaicon">
			<img id="socialfacebook" class="socialmediaiconimg" src="img/facebook.png" />
		</div>
	</a>
	<a target="_blank"  href="https://twitter.com/1tayyabs">
		<div class="socialmediaicon">
			<img id="socialtwitter" class="socialmediaiconimg" src="img/twitter.png" />
		</div>
	</a>
	<div class="followus">
		Follow us on:
...
<iframe src="https://snapwidget.com/embed/352217" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:100%; "></iframe>
<a target="_blank"  href="https://www.instagram.com/1tayyabs/">
...
<script>
  function initMap() {
	var uluru = {lat: 51.5172403, lng: -0.0634757};
...
<script async defer
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC-M_r4QrPL5C6ZJ88f63EQlsX8BbG5ft0&callback=initMap">
</script>
<div class="footer">
	<div class="contactusbox">
		Open all day | 12AM - 11:30PM
	</div>
	<div class="contactusbox2">
		83-89 FIELDGATE ST, LONDEN E1 1JU<BR/>
		Call us: 020 7247 6400
	</div>
</div>
<!--
<div id="about">
